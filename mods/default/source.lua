...
--[[
 ...
 def = {
		...
		direction = dir,
		scale = {x=1,y=1},
		size = {x = math.max(((xsize and math.max(math.floor(xsize),1) or 24)/CODELAND.resolution[1])*3.355/ratio2/ratio4,1)*screen_w/1920, y = math.max(((ysize and math.max(math.floor(ysize),1) or 24)/CODELAND.resolution[2])*3.355/ratio3/ratio4,1)*screen_h/1080},
  ...
  image = string
	...
	def = {
		...
		direction = dir,
		scale = {x=1,y=1},
		size = {x = math.max(((xsize and math.max(math.floor(xsize),1) or 24)/CODELAND.resolution)*3.355/ratio2/ratio4,1)*screen_w/1920, y = math.max(((ysize and math.max(math.floor(ysize),1) or 24)/CODELAND.resolution)*3.355/ratio3/ratio4,1)*screen_h/1080},
		offset = {x=0,y=0},--{x = ((((math.floor(x)/ratio2/ratio4+ (CODELAND.width/2*(1-(1/ratio2/ratio4))) )/CODELAND.width) -.5) *2)*((10 * 24) + 300), y = ((1 - ((math.floor(y)/ratio3/ratio4 + (CODELAND.height/2*(1-(1/ratio3/ratio4))) )/CODELAND.height)) *2/2)*(-(10*60))},
		z_index = 2,
	}
	end
...
--[[
 ...
 def = {
		...
		number = hex,
		direction = dir,
		size = {x = ((xsize and math.max(math.floor(xsize),1)/12 or 1)/CODELAND.resolution[1]/ratio2/ratio4)*screen_w/1920, y = ((ysize and math.max(math.floor(ysize),1)/12 or 1)/CODELAND.resolution[2]/ratio3/ratio4)*screen_h/1080},
		offset = {x=0,y=0},--{x = ((((math.floor(x)/ratio2/ratio4 + (CODELAND.width/2*(1-(1/ratio2/ratio4))) )/CODELAND.width) -.5) *2)*((10 * 24) + 300), y = ((1 - ((math.floor(y)/ratio3/ratio4 + (CODELAND.height/2*(1-(1/ratio3/ratio4))) )/CODELAND.height)) *2/2)*(-(10*60))},
		z_index = 2,
	}
 else
 def = {
		...
		number = hex,
		direction = dir,
		size = {x = ((xsize and math.max(math.floor(xsize),1)/12 or 1)/CODELAND.resolution/ratio2/ratio4)*screen_w/1920, y = ((ysize and math.max(math.floor(ysize),1)/12 or 1)/CODELAND.resolution/ratio3/ratio4)*screen_h/1080},
		offset = {x=0,y=0},--{x = ((((math.floor(x)/ratio2/ratio4 + (CODELAND.width/2*(1-(1/ratio2/ratio4))) )/CODELAND.width) -.5) *2)*((10 * 24) + 300), y = ((1 - ((math.floor(y)/ratio3/ratio4 + (CODELAND.height/2*(1-(1/ratio3/ratio4))) )/CODELAND.height)) *2/2)*(-(10*60))},
		z_index = 2,
	}
 end
